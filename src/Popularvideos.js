...
//     const url = "https://youtube.googleapis.com/youtube/v3/videos?part=snippet%2CcontentDetails%2Cstatistics&chart=mostPopular&maxResults=20&regionCode=US&key=AIzaSyAsBoMMYM1U5cd8XT2p73yiDZ2GFokA01g";

//     const [poular, setPopular] = useState(null);
...
fetch('https://youtube.googleapis.com/youtube/v3/videos?part=snippet%2CcontentDetails%2Cstatistics&chart=mostPopular&maxResults=20&regionCode=US&key=AIzaSyAsBoMMYM1U5cd8XT2p73yiDZ2GFokA01g')
    .then((response)=>response.json())
    .then((popularvids)=>popVids.push(popularvids));

// export default popVids;


// popularvids[0].items.map(videos=>{
//     return <VideoCard 
//       title={videos.snippet.title}
//       views = {`${numeral(videos.statistics.viewCount).format("0.a")} Views` }
//       timestamp={moment(videos.snippet.publishedAt).fromNow()}
//       channelImage = {videos.snippet.thumbnails.default}
...
// {
//     {poular}.poular[0].items.map(videos=>{
//       return <VideoCard 
//         title={videos.snippet.title}
//         views = {`${numeral(videos.statistics.viewCount).format("0.a")} Views` }
//         timestamp={moment(videos.snippet.publishedAt).fromNow()}
...
const url = "https://youtube.googleapis.com/youtube/v3/videos?part=snippet%2CcontentDetails%2Cstatistics&chart=mostPopular&maxResults=20&regionCode=US&key=AIzaSyAsBoMMYM1U5cd8XT2p73yiDZ2GFokA01g";
  ...
  const [poular, setPopular] = useState([]);
...
// import popularvids from "./Popularvideos";
